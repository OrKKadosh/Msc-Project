...
#     accuracy_metric = evaluate.load('accuracy', use_auth_token=False)
#     precision_metric = evaluate.load("precision", use_auth_token=False)
#     recall_metric = evaluate.load("recall", use_auth_token=False)
    ...
    for model in base_models:
        ...
        for inner_model in base_and_pt_models:  # Iterate over models (base, pre-trained, RD pre-trained)
            for eval_dataset in eval_datasets:
                if(idx == 0): eval_dataset_name = '75_consent'
                else: eval_dataset_name  = 'all_agree'
                ...
                trainer = Trainer(
                    ...
                    compute_metrics=compute_manual_metrics,
                )
