...
os.makedirs("Data/test_datasets/split_eval_test/", exist_ok=True)


# Saving to CSV if needed
consent_75_test.to_csv("Data/test_datasets/split_eval_test/consent_75_test.csv", index=False)
consent_75_eval.to_csv("Data/test_datasets/split_eval_test/consent_75_eval.csv", index=False)
all_agree_test.to_csv("Data/test_datasets/split_eval_test/all_agree_test.csv", index=False)
all_agree_eval.to_csv("Data/test_datasets/split_eval_test/all_agree_eval.csv", index=False)